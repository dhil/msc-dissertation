...
\end{center}
\begin{center}
{\color{white}{This talk may contain traces of jargon such as \emph{monads}, \emph{effects}, \emph{algebras} and \emph{handlers}. However the following code examples in this talk may be performed at home. }}
\end{center}
\end{frame}
\endgroup
